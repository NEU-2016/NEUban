...
insert into user (id,password,user_name, role)
values (7,'$2a$08$0E.G3Tt9BsDtapmmc1pgruh4myKCy6ySEi//ptScWjRmres1U0txi','falatka', 'USER');

INSERT INTO user(id, user_name, password, role) VALUES(1, 'admin', 'admin', 'ADMIN');
