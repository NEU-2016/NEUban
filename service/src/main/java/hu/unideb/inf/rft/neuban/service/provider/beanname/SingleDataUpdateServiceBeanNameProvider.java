...
public class SingleDataUpdateServiceBeanNameProvider {
    private SingleDataUpdateServiceBeanNameProvider() {}

    public static final String SINGLE_USER_DATA_UPDATE_SERVICE = "singleUserDataUpdateService";
