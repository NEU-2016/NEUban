...
public class SingleDataConverterBeanNameProvider {
    ...
    public static final String SINGLE_COLUMN_DATA_CONVERTER = "singleColumnDataConverter";
    public static final String SINGLE_CARD_DATA_CONVERTER = "singleCardDataConverter";
    public static final String SINGLE_COMMENT_DATA_CONVERTER = "singleCommentDataConverter";
}
